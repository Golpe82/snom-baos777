...
#        print("Subscribed: "+str(mid)+" "+str(granted_qos))
    ...
    def connect_and_subscribe(self, ip='127.0.0.1', port=1883, user='Keiner', password='Nix' ):
        if self.enable:
            if user != 'Keiner':
...
if __name__ == "__main__":
    ...
    rc = mqttc.connect_and_subscribe('127.0.0.1', port=1883, user='Keiner', password='Nix' )
